class Admin::TopicCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @topic_category.save
        format.html do
          redirect_to admin_topic_category_url(@topic_category), notice: "Topic category was successfully created."
        end
  ...
  def update
    respond_to do |format|
      if @topic_category.update(topic_category_params)
        format.html do
          redirect_to admin_topic_category_url(@topic_category), notice: "Topic category was successfully updated."
        end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_topic_categories_url, notice: "Topic category was successfully destroyed." }
  ...
  def topic_category_params
    params.require(:topic_category).permit(:name, :description, :image)
  end
end
